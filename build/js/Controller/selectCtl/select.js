...
require(['app'],function(app){
    ...
    app.constant("type2","../JSON/areali_1.json");
    app.constant("type4","../JSON/areali_2.json");
    app.constant("type6","../JSON/areali_3.json");
    app.constant("type1","../JSON/areawen_1.json");
    app.constant("type3","../JSON/areawen_2.json");
    app.constant("type5","../JSON/areawen_3.json");
    app.constant("type8","../JSON/areagl_1.json");
    app.constant("type7","../JSON/areagw_1.json");
    app.controller("wishTabCtr-attr",['$rootScope','$scope',"$timeout",'$location',"ZYBinfoDATA","provinceURL","propURL","AJAX","tubeURL","loadClickEvent","loadDblclickEvent","loadClickAll","loadClickCancle","loadCancleAll",'type1','type2','type3','type4','type5','type6','type7','type8',function($rootScope,$scope,$timeout,$location,ZYBinfoDATA,provinceURL,propURL,AJAX,tubeURL,loadClickEvent,loadDblclickEvent,loadClickAll,loadClickCancle,loadCancleAll,type1,type2,type3,type4,type5,type6,type7,type8){
